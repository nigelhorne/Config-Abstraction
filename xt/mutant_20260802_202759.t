...
# --- SURVIVOR: COND_INV_2164_2 (MEDIUM) line 2164 in encrypt_value() ---
# Source:  unless($self->_load_driver('Crypt::AuthEnc::GCM')) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
    local $TODO = 'Complete: COND_INV_2164_2 line 2164 in encrypt_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 2164 in encrypt_value() to detect the mutant
    fail('COND_INV_2164_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_2167_2 (MEDIUM) line 2167 in encrypt_value() ---
# Source:  unless($self->_load_driver('Crypt::PRNG', ['random_bytes'])) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
    local $TODO = 'Complete: COND_INV_2167_2 line 2167 in encrypt_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 2167 in encrypt_value() to detect the mutant
    fail('COND_INV_2167_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2179_2 (MEDIUM) line 2179 in encrypt_value() ---
# Source:  return 'ENC[AES256GCM,' . MIME::Base64::encode_base64url($nonce . $ct . $tag, '') . ']';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2179_2 line 2179 in encrypt_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 2179 in encrypt_value() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_2179_2 line 2179 in encrypt_value() ---
# Source:  return 'ENC[AES256GCM,' . MIME::Base64::encode_base64url($nonce . $ct . $tag, '') . ']';
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Config::Abstraction requires constructor arguments, add them here.
# my $obj = new_ok('Config::Abstraction');
# ok($obj->..., 'RETURN_UNDEF_2179_2: add assertion here');
