...
# --- SURVIVOR: BOOL_NEGATE_792_2 (MEDIUM) line 792 in _load_data_reuse() ---
# Source:  return 0 if($self->{'no_fixate'});
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_792_2 line 792 in _load_data_reuse()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 792 in _load_data_reuse() to detect the mutant
    fail('BOOL_NEGATE_792_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_794_2 (MEDIUM) line 794 in _load_data_reuse() ---
# Source:  return 1 if($self->{reuse_loaded});
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_794_2 line 794 in _load_data_reuse()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 794 in _load_data_reuse() to detect the mutant
...
# --- SURVIVOR: COND_INV_994_2 (MEDIUM) line 994 in AUTOLOAD() ---
# Source:  if ($self->{flatten}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_994_2 line 994 in AUTOLOAD()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 994 in AUTOLOAD() to detect the mutant
    fail('COND_INV_994_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_995_3 (MEDIUM) line 995 in AUTOLOAD() ---
# Source:  return $data->{$key} if(exists $data->{$key});
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_995_3 line 995 in AUTOLOAD()';
    # NOTE: new() called with no arguments as a starting point.
    # If Config::Abstraction requires constructor arguments, add them here.
    my $obj = new_ok('Config::Abstraction');
    # TODO: exercise line 995 in AUTOLOAD() to detect the mutant
    fail('BOOL_NEGATE_995_3: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_792_2 line 792 in _load_data_reuse() ---
# Source:  return 0 if($self->{'no_fixate'});
...
# --- LOW HINT: RETURN_UNDEF_794_2 line 794 in _load_data_reuse() ---
# Source:  return 1 if($self->{reuse_loaded});
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_995_3 line 995 in AUTOLOAD() ---
# Source:  return $data->{$key} if(exists $data->{$key});
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
